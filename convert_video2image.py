...
def exc_fn(data_path, scene, video_list, idx):
    ...
    with tqdm(position=idx) as progress:
        ...
        for video_path in video_list:
            ...
            root = os.path.join(data_path, f"images_x2/{basename}")
            ...
            for idx in range(video_len):
                ...
                img0_path = os.path.join(root, f'{idx}.png')
                img0.save(img0_path)
    ...
    with open(os.path.join(data_path,'images_x2_list.json'), 'w') as outfile:
